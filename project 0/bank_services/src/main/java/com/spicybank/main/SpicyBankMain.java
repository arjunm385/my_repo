...
public class SpicyBankMain {
	private static Logger log = Logger.getLogger(SpicyBankMain.class);

	public static void main(String[] args) {
		Emp_Details empdetailsImpl = new com.spicybank.service.Impl.Emp_DetailsImpl();
		User_Details userdetailsImpl = new com.spicybank.service.Impl.User_DetailsImpl();
		...
		do {
			log.info("Welcome to SPICY Banking Service App v1.0");
			log.info("===========================================");
			...
			log.info("#For any queries, feel free to contact @support.spicy.com");
			try {
					...
					do {
						...
						try {
							...
							case 1:
								...
								int s2;
								do {
									log.info("Welcome to SPICY Banking Services");
							...
							case 2:
								...
								do {
									...
									log.info("Welcome :" + name + " to SPICY Banking Service App");
									log.info("===========================================");
				...
				case 2:
					...
					log.info("Welcome to SPICY Family. Please enter the following details for getting registered !");
					log.info("===========================================");
